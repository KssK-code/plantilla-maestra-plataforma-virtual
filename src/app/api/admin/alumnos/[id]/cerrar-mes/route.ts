...
export async function POST(
  ...
  try {
    ...
    // El rango sale de `rangoMateriasDelMes`, que vive junto a la ventana de
    // acceso para que las dos no puedan divergir: al cerrar el mes N hay que
    // tocar EXACTAMENTE las materias que ese mes abrió.
    //
